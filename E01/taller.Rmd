...
author: "Geraldine Home Senz - Jose David Soba Loaiza"
date: "2024-03-06"
...
Basado en el ECM en los 200 datos de prueba, se determina que el modelo de regresión Lasso (`r mse_lasso`) es más apropiado para propósitos de predicción en comparación con el modelo de regresión Ridge (`r mse_lasso`).
