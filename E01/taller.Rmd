...
Los valores óptimos de $λr$ y $λl$ para la regresión Ridge y Lasso, respectivamente, que minimizan el error cuadrático medio (ECM) mediante validación externa utilizando los 1000 datos de entrenamiento son $12.85042$ y $0.07526521$. Estos valores fueron seleccionados a través de la técnica de validación cruzada con 10 folds.
...
Basado en el ECM en los 200 datos de prueba, se determina que el modelo de regresión Lasso es más apropiado para propósitos de predicción en comparación con el modelo de regresión Ridge.
...
ggplot(coefs_df, aes(x = coeficiente, y = reorder(variable, coeficiente), fill = signo)) +
  ...
  labs(title = "Trazas de coeficientes en función de la penalización",
